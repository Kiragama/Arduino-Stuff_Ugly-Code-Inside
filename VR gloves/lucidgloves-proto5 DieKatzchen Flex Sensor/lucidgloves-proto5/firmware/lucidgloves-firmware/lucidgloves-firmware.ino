...
#define JOYAMP 1000 //default is 0 and is how much joysticks should get a +/- amp to them.
//1000 value used 10k resistors to GND. Removes noise
#define X_SHIFTRIGHT 300 //Shift the Center location of the joystick by increasing the default
#define Y_SHIFTUP 0
//Note, steamvr uses a virtual circle and if the values do not touch the edge, then a move is not detected.
  ...
  #define PIN_PINKY     10 //E These 5 are for flexion
  #define PIN_RING      1 //D
  #define PIN_MIDDLE    15//C 
  #define PIN_INDEX     4 //B
  #define PIN_THUMB     2 //A
  #define PIN_JOY_X     14//F
  #define PIN_JOY_Y     13//G
  ...
  #define FLEXION_MIXING MIXING_NONE
    ...
    #define PIN_PINKY_SECOND     -1 
    #define PIN_RING_SECOND      -1
    #define PIN_MIDDLE_SECOND    -1
    #define PIN_INDEX_SECOND     -1
