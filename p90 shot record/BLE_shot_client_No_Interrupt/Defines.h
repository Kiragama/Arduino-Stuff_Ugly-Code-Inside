...
#define ENABLED false //used to control sleep



unsigned volatile static long last_time;
volatile uint32_t count = 0;  //volatile stops the compiler from assuming the value and actually check. Required if interrupts used
