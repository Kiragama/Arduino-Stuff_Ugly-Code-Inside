...
class Display_Stuff : public DFRobot_ST7735_80x160_HW_SPI, public Resources_Base {
protected:
...
public:
  Display_Stuff()
    : DFRobot_ST7735_80x160_HW_SPI(TFT_DC, TFT_CS, TFT_RST){ /*Anything in here doesn't do anything*/ };
  ~Display_Stuff() { };
